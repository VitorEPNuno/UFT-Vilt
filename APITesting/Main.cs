    ...
    *  in HP Service Test.
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            string xmlDataFetchActivity7Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>2e78e8e8-39d8-405a-a81e-d02c00640cad</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>Training Data Source</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>True</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value></Value></QueryParameter><QueryParameter><Name>TableStructure</Name><Value>NumberTickets,String,</Value></QueryParameter><QueryParameter><Name>TableContents</Name><Value>2^3^4</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            _flow.DataExporterActivity9.InDirections.Add(bind_dir9);
            ...
            _flow.DataDisconnectActivity8.InDirections.Add(bind_dir10);
            ...
            VTDPropertyInfoBase pi22 = new VTDPropertyInfoBase("InTable");
            VTDBaseSetter binding_setter11 = new VTDObjectSetter(pi22);
            binding_setter11 = new StringFormaterDecorator(binding_setter11,"{Step.DataFetchActivity7.OutTable}");
            bind_dir11 = new BindDirection(_flow.DataFetchActivity7,binding_getter11,binding_setter11,BindTargetType.ToInProperty);
            this.DataCursorActivity11.InDirections.Add(bind_dir11);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>First</Class><CustomerName>Rob</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity4.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>{DataSource.Training Data Source.NumberTickets}</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi23 = new VTDPropertyInfoBase("NumberTickets");
            VTDBaseGetter binding_getter12 = new VTDObjectGetter(pi23);
            VTDPropertyInfoBase pi24 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='NumberOfTickets'][1]");
            ...
            VTDPropertyInfoBase pi25 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][{Array0}]/*[local-name(.)='FlightNumber'][1]");
            ...
            VTDPropertyInfoBase pi27 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='FlightDate'][1]");
            VTDBaseGetter binding_getter14 = new VTDXPathGetter(pi27,XmlTypeCode.DateTime);
            VTDPropertyInfoBase pi28 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='DepartureDate'][1]");
            VTDBaseSetter binding_setter14 = new VTDXPathSetter(pi28,XmlTypeCode.DateTime);
